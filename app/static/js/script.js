...
function updateBars() {
    ...
    let barDown = document.getElementsByClassName('conjbar')[0] // pegando a div que tem as barras inferiores
    ...
    for (let i = 0; i < bars.length; i++) {
        bars[i].addEventListener('animationend', animationBar)
    }
}
